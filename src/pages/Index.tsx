            ...
            <div className="order-2 md:order-1">
              <ScrollReveal delay={200}>
                ...
                <p className="text-lg text-gray-600 mb-8 max-w-xl">
                  Helping visionary entrepreneurs and creators integrate AI to
                  transform their businesses and reach new heights.
                </p>
                <Button
                  className="px-8 py-6 bg-black text-white text-lg hover:bg-gray-800"
                  onClick={() =>
                    window.open(
          ...
          <div className="text-center mb-12 md:mb-16">
            <ScrollReveal>
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Strategic AI integration services tailored to enhance your
          ...
          <div className="text-center mb-12 md:mb-16">
            <ScrollReveal>
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                ...
                operations and growth with our AI integration strategies.
              </p>
            </ScrollReveal>
          </div>
          ...
          <div className="max-w-2xl mx-auto text-center">
            <ScrollReveal>
              ...
              <p className="text-gray-600 mb-8">
                Subscribe to receive weekly tips, insights, and strategies on
            ...
            <ScrollReveal>
              <div>
                ...
                <p className="text-gray-600">
                  Thoughts and strategies on AI integration for modern
                  businesses.
                </p>
              </div>
            </ScrollReveal>
