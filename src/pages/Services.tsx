            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
              ...
              <div>
                <h2 className="text-3xl font-playfair mb-4">
                  Free Website Design & Mockup
                </h2>
                <p className="text-gray-600 mb-6">
                  Get started with a complimentary website design and mockup.
                  We'll create a vision for your digital presence that aligns
                  perfectly with your brand and goals.
                </p>
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <p className="text-gray-600">
                      Interactive mockups for visualization
                    </p>
                  </div>
                </div>
                <Button
          ...
          <ScrollReveal delay={100}>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
              ...
              <div className="order-2 lg:order-1">
                ...
                <p className="text-gray-600 mb-6">
                  Turn visitors into valuable leads with our comprehensive lead
                  generation system, designed to capture and nurture potential
                  clients.
                </p>
                <div className="space-y-3 mb-6">
                  <div className="flex items-start">
          ...
          <ScrollReveal delay={200}>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-6">
                  Enhance your customer experience with our integrated support
                  system, designed to provide timely and effective assistance.
                </p>
                <div className="space-y-3 mb-6">
                  <div className="flex items-start">
                    <div className="mr-3 text-black mt-1">
